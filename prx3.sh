...
#warppoint1
  ...
  sudo dd if=/dev/zero of=/var/swap.img bs=1024k count=12288
  ...
  echo "maxconnections=10" >> /home/${COINl}${nodeunit}/.${COINl}/${COINCONFIG}
...
Function_Read_Masternode_Key_Table(){
  ...
  unzip /root/prx.zip -d /home/${COINl}1/.${COINl}
#add hash Check
#compare hash
  #Test_Pause
  rm -rf /root/${COIN3l}
